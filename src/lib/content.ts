...
const CONTENT_POOL: DailyItem[] = [
  ...
  },
  {
    ...
    body: "New data suggests socks are not lost, but promoted. The Department notes this finding remains unconfirmed by the Lost & Found Authority, which was not consulted, and would like to be.",
    rarity: "common",
    tags: ["sock-inquiry"],
  ...
  },
  {
    ...
    body: "Historians have concluded the world's first traffic jam was likely two people arguing about who invented the wheel first. The wheel was not consulted.",
    rarity: "common",
  },
  ...
  },
  {
    ...
    body: "When questioned on this quarter's decision-making, the Committee cited the Duck Harbor Master Precedent (1622) and considers the matter closed.",
    rarity: "common",
    tags: ["duck-harbor-master"],
  ...
  },
  {
    ...
    body: "The neighborhood cats have resumed their nightly rooftop meetings. Agenda items remain, as always, classified. All parties were assessed with reasonable certainty to be plotting something.",
    rarity: "common",
  },
  ...
  },
  {
    ...
    format: "Custodial Note",
    title: "Custodial Note",
    body: "A jar labeled DO NOT OPEN — SERIOUSLY has been awaiting recognition for six years. Staff confirm it has not been opened. Staff confirm they think about it often.",
    rarity: "common",
  },
  ...
  },
  {
    ...
    format: "Reminder",
    title: "Reminder",
    body: "Residents are reminded that Tuesday, having already been extended twice, will not be extended a third time. Probably.",
    rarity: "common",
    tags: ["tuesday-compromise"],
  },
  {
    ...
    format: "Public Notice",
    title: "Public Notice",
    body: "Residents are reminded that all complaints regarding the weather should be submitted in triplicate to nobody in particular.",
    rarity: "common",
  },
  ...
  },
  {
    ...
    body: "The Bureau confirms it was established in 2009, the same year as the Office of Public Clarifications. Any relationship between these two facts remains a situation of moderate note.",
    rarity: "common",
    tags: ["reorg-2009"],
  ...
  },
  {
    ...
    title: "Advisory",
    body: "Per the precedent set in 1975, a resident reporting their apartment as “mildly haunted” has been advised the matter is concerning, but not actionable.",
    rarity: "common",
    tags: ["emotionally-haunted-ruling"],
